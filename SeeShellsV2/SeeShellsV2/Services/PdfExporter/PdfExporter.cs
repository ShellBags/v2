...
namespace SeeShellsV2.Services
{
	public class PdfExporter : IPdfExporter
	{
		...
		public void Export()
		{
			...
			PdfDocumentRenderer renderer = PdfDocumentRenderer(true, PdfSharp.Pdf.PdfFontEmbedding.Always);
		...
		static Document CreateDocument()
		{
			...
			Cover.DefineCover(doc);
			DefineContentSection(doc);

			Paragraphs.DefineParagraphs(doc);
			Tables.DefineTables(doc);
			Charts.DefineCharts(doc);
